...
static double shooterPivotOffset() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return 0;
        case SIDE_SWIPE_TEAM_NUMBER:
            return 0;
        default:
            return 51.9;
    }
};
static units::degree_t pigeonMountPitch() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return 0_deg;
        case SIDE_SWIPE_TEAM_NUMBER:
            return 0_deg;
        default:
            return 0.037622284_deg;
    }
};
static units::degree_t pigeonMountRoll() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return -0.395508_deg;
        case SIDE_SWIPE_TEAM_NUMBER:
            return 0_deg;  // Temp value; TODO: Change it
        default:
            return -0.784180343_deg;
    }
};
static units::degree_t pigeonMountYaw() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return -1.477661_deg;
        case SIDE_SWIPE_TEAM_NUMBER:
            return 0_deg;  // Temp value; TODO: Change it
        default:
            return -90.230049133_deg;
    }
};

static std::vector<double> swerveZeros() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return {0.3867, 0.8890, 0.0763, 0.610};
        case SIDE_SWIPE_TEAM_NUMBER:
            return {0.3106, 0.4369, 0.4780, 0.7372};
        default:
            return {0.4240722, .85498046875, 0.471924,
                    0.081299};  // 0.86669921875 {0.4240722, 0.857666, 0.471924, 0.078125};
    }
};

static units::meter_t moduleDiff() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return 0.2413_m;
        case SIDE_SWIPE_TEAM_NUMBER:
...
static units::meter_t driveBaseRadius() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return 0.36_m;
        case SIDE_SWIPE_TEAM_NUMBER:
...
static std::vector<bool> swerveDrivesReversals() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
...
static std::vector<bool> swerveAzimuthsReversals() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
...
static frc::Pose3d mintCameraPosition() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return frc::Pose3d();
        case SIDE_SWIPE_TEAM_NUMBER:
            return frc::Pose3d{0.2921_m,                                   // x
                               -0.16906875_m,                              // y
                               0.28575_m,                                  // z
                               frc::Rotation3d{-180_deg, 28_deg, 0_deg}};  // Temp value; TODO: Change it
        default:
            return frc::Pose3d{-13.295_in,  // x
                               0_in,        // y
                               8.928_in,    // z
                               frc::Rotation3d{0_deg, 28.7_deg, -180_deg}};
    }
};

static frc::Pose3d vanillaCameraPosition() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return frc::Pose3d();
        case SIDE_SWIPE_TEAM_NUMBER:
            return frc::Pose3d(0.2921_m,                                   // x
                               ...
                               frc::Rotation3d{-180_deg, 28_deg, 0_deg});  // Temp value; TODO: Change it
        default:
            return frc::Pose3d(-11.535_in,  // x
                               11.513_in,   // y
                               10.175_in,   // z
                               frc::Rotation3d(0_deg, 37_deg, 125_deg));
    }
};

static frc::Pose3d chocolateCameraPosition() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return frc::Pose3d();
        case SIDE_SWIPE_TEAM_NUMBER:
            return frc::Pose3d();
        default:
            return frc::Pose3d(-11.675_in,  // x
                               -11.217_in,  // y
                               10.175_in,   // z
                               frc::Rotation3d(0_deg, 39.7_deg, -125_deg));
    }
};

static frc::Pose3d lemonCameraPosition() {
    switch (teamNumber) {
        case ALPHA_TEAM_NUMBER:
            return frc::Pose3d{-0.0635_m, 0.3175_m, 0.6731_m, frc::Rotation3d{0_deg, 28_deg, 0_deg}};
        case SIDE_SWIPE_TEAM_NUMBER:
            return frc::Pose3d{-0.0635_m, 0.3175_m, 0.6731_m,
                               frc::Rotation3d{0_deg, 28_deg, 0_deg}};  // Temp value; TODO: Change it
        default:
            return frc::Pose3d{-0.0635_m, 0.3175_m, 0.6731_m,
                               frc::Rotation3d{0_deg, 28_deg, 0_deg}};  // Temp value; TODO: Change it
    }
...
static std::vector<std::pair<const char*, frc::Pose3d>> aprilCameras{
    std::pair("limelight-mint", mintCameraPosition()), std::pair("limelight-lemon", lemonCameraPosition()),
    std::pair("limelight-choco", chocolateCameraPosition()), std::pair("limelight-vanilla", vanillaCameraPosition())};
}  // namespace Constants
