 ...
 *
 * Example from: @link
 * https://github.com/CrossTheRoadElec/Phoenix-Examples-Languages/blob/master/C%2B%2B%20General/CANdle/src/main/cpp/subsystems/CANdleSystem.cpp
 * @endlink
 */
class CANdleSensor : public valor::BaseSensor<int> {
   public:
     ...
     */
    enum AnimationType { None, ColorFlow, Fire, Larson, Rainbow, RgbFade, SingleFade, Strobe, Twinkle, TwinkleOff };
