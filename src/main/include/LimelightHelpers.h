...
#ifndef FRC_6800_2024_CODE_SRC_MAIN_INCLUDE_LIMELIGHTHELPERS_H_
#define FRC_6800_2024_CODE_SRC_MAIN_INCLUDE_LIMELIGHTHELPERS_H_
...
inline void setLimelightNTDoubleArray(const std::string& tableName, const std::string& entryName,
 ...
 */
inline void setCropWindow(const std::string& limelightName, double cropXMin, double cropXMax, double cropYMin,
                          double cropYMax) {
...
inline void setPythonScriptData(const std::string& limelightName, const std::vector<double>& outgoingPythonData) {
    setLimelightNTDoubleArray(limelightName, "llrobot",
...
#endif  // FRC_6800_2024_CODE_SRC_MAIN_INCLUDE_LIMELIGHTHELPERS_H_
