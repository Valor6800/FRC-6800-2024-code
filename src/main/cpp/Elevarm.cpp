...
Elevarm::Elevarm(frc::TimedRobot *_robot, Intake *_intake) : valor::BaseSubsystem(_robot, "Elevarm"),                        
                            ...
                            wristMotor(CANIDs::WRIST, valor::NeutralMode::Brake, false, "baseCAN"),
...
void Elevarm::analyzeDashboard()
{
    ...
    if(coastMode && armRotateMotor.getNeutralMode() == valor::NeutralMode::Brake){
        
        armRotateMotor.setNeutralMode(valor::NeutralMode::Coast);
    } else if(armRotateMotor.getNeutralMode() == valor::NeutralMode::Coast && !coastMode){
        armRotateMotor.setNeutralMode(valor::NeutralMode::Brake);
    }
